...
test_that("read_pmetrics throw warnings and error", {
  ...
  expect_warning(
    read_pmetrics(data = test_path("testdata/pmetrics_file/PMtest_old.csv")),
...
test_that("read_pmetrics : mandatory variable not present", {
  expect_error(
    read_pmetrics(test_path("testdata/pmetrics_file/PM_error.csv"), pm_vers = 2),
...
test_that("read_pmetrics recognize first gen Pmetrics (csv)", {
  ...
  old_version_csv <- test_path("testdata/pmetrics_file/PMtest_old.csv")
  output_csv_old <- read.csv(old_version_csv, skip = 1, header = TRUE)
  attr(output_csv_old, "software") <- "pm.object"
...
test_that("read_pmetrics recognize first gen Pmetrics (csv EUR)", {
  old_version_csv2 <- test_path("testdata/pmetrics_file/PMtest_old_csv2.csv")
  #output_csv_old <- read.csv(old_version_csv, skip = 1, header = TRUE)
...
test_that("read_pmetrics recognize first gen Pmetrics (XLSX)", {
  old_version_xlsx <- test_path("testdata/pmetrics_file/PMtest_old.xlsx")
  #output_csv_old <- read.csv(old_version_csv, skip = 1, header = TRUE)
...
test_that("read_pmetrics recognize first gen Pmetrics (xls)", {
  old_version_xls <- test_path("testdata/pmetrics_file/PMtest_old.xls")
  #output_csv_old <- read.csv(old_version_csv, skip = 1, header = TRUE)
...
test_that("read_pmetrics recognize second gen Pmetrics (csv)", {
  new_version_csv <- test_path("testdata/pmetrics_file/PMtestv2.csv")               #full file nothing to change
  minimal_wo_cov <- test_path("testdata/pmetrics_file/PMtestv2_minimal.csv")        # minimal data no covariat
  ...
  expect_equal(read_pmetrics(minimal_wo_cov, pm_vers = 2)[-9, ], expected_output_wo_cov) #expected_output_new_version[-9, -c(15:16)])
  expect_equal(read_pmetrics(minimal_with_cov, pm_vers = 2)[-9, ], expected_output_with_cov) #expected_output_new_version[-9, ])

})

test_that("read_pmetrics recognize second gen Pmetrics (XLSX)", {
  new_version_xlsx <- test_path("testdata/pmetrics_file/PMtest.xlsx")
...
test_that("read_pmetrics recognize second gen Pmetrics (XLS)", {
  new_version_xls <- test_path("testdata/pmetrics_file/PMtest.xls")
